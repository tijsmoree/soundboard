...
AS
	...
	NOT ISNULL(n.id) AS is_normal_member,
	NOT ISNULL(a.id) AS is_alumnus,
	NOT ISNULL(a_m.id) AS is_associate_member,
	NOT ISNULL(b_m.person_id) AS is_or_was_board_member,
	NOT ISNULL(c_m.person_id) AS is_committee_member,
	NOT ISNULL(c_m2.person_id) AS is_or_was_committee_member,
	NOT ISNULL(h.person_id) AS is_honorary_member,
	CASE
